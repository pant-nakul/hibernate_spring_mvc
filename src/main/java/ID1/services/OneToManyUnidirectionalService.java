...
/*
//        Associations to find the Employee whose account contains more than 500 in desc order of account using oneToMany
            Criteria accountEntityCriteria = criteria.createCriteria("accounts");
            accountEntityCriteria.add(Restrictions.ge("deposit", 500));
